(function (win) {
	...
	/**
	 * 图搜助手资讯版 by Reacher
	 * 需求地址：http://199.155.122.129:8080/pages/viewpage.action?pageId=18972696
	 * 覆盖：新浪微博，腾讯微博，豆瓣网，人人网，天涯论坛，猫扑，百度贴吧，新浪，腾讯，网易，搜狐
	 * 目前覆盖：豆瓣网，新浪微博
	 **/
	/*function infoMedia() {
	 // if (href.match(/.weibo.com|t.qq.com|.douban.com|.renren.com|bbs.tianya.cn|.mop.com|sina.com.cn|.qq.com|.163.com|.sohu.com/)) {
	 if (href.match(/.weibo.com|.douban.com/)) {
	 // 仅chrome浏览器下出交互
	 if (navigator.userAgent.indexOf('Chrome')) {
	 // load('http://www.ttsunion.com/js/tts_infomedia_center.js?v=@@timestamp');
	 load('http://re.taotaosou.com/browser-static/media/tts_infomedia_center.js?v=@@timestamp');
	 }
	 }
	 }*/

__tk__define(function (require, exports, module) {
	...
	var comparatorHelpers = {
		...
		transUrl: function (from, url, id) {
			if (from == 3) {
				return "http://www.chaoji99.com/search.html?" + "http://www.chaoji99.com/item.html?sourceId=" + id +
					"&website=taobao";
			} else {
				return "http://search.taotaosou.com/transfer.htm?" + url;
			}
